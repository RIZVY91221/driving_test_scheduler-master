...
class  SecondAvailableTestTimes extends StatefulWidget {

  SecondAvailableTestTimes() : super();

  @override
  _SecondAvailableTestTimesState createState() => _SecondAvailableTestTimesState();
}

class _SecondAvailableTestTimesState extends State<SecondAvailableTestTimes> {
  List availabeTest=[
